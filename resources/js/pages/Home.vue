...
<div>
  <label class="mb-1 block text-sm font-medium text-gray-700">🏠 Home Win Rate (%)</label>
  <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
    <span>Min: {{ homeWinRateMin }}%</span>
    <span>Max: {{ homeWinRateMax }}%</span>
  </div>
  <div class="flex items-center gap-2">
    <input
      type="range"
...
<div>
  <label class="mb-1 block text-sm font-medium text-gray-700">🚗 Away Win Rate (%)</label>
  <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
    <span>Min: {{ awayWinRateMin }}%</span>
    <span>Max: {{ awayWinRateMax }}%</span>
  </div>
  <div class="flex items-center gap-2">
    <input
      type="range"
      ...
      class="w-1/2 accent-blue-500 transition-all"
    />
    <input
      type="range"
      min="0"
...
<div>
  <label class="mb-1 block text-sm font-medium text-gray-700">⚠️ Away Loss Rate (%)</label>
  <div class="flex items-center justify-between text-xs text-gray-500 mb-1">
    <span>Min: {{ awayLossRateMin }}%</span>
    <span>Max: {{ awayLossRateMax }}%</span>
  </div>
  <div class="flex items-center gap-2">
    <input
      type="range"
