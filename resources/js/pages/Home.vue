                    ...
                    <div class="bg-white border border-indigo-100 p-6 rounded-2xl shadow-md space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <select v-model="comboRisk"
                                    class="mt-1 w-full rounded-lg border-gray-200 shadow-sm text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" v-model.number="homeRankLimit" min="1" max="100"
                                    class="mt-1 w-full rounded-lg border-gray-200 shadow-sm text-sm" />
                            </div>
                            <div>
                                <label class="text-sm font-medium text-gray-600">Max Away Rank</label>
                                <input type="number" v-model.number="awayRankLimit" min="1" max="100"
                                    class="mt-1 w-full rounded-lg border-gray-200 shadow-sm text-sm" />
                            </div>
                        </div>
